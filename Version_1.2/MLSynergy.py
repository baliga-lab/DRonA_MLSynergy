...
def main(argv):
    #### help strings
    help_str1 = "MLSynergy.py --command <> --[conditional]classifier <> --[conditional]metadata <> --[conditional]combinaitons --[conditional]data <> --output <> [OPTIONS]"
...
--[conditional]data or -d: <str> If command = Score_combinations; datafile of single drug treatments with gene expession data (csv format)\n\
--[conditional]output or -o: <str> If command = Make_combinations; file handle to write the output of combinations to (end the outout file handle with .csv) in\n\
OPTIONS:\n\
